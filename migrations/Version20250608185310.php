 ...
 */
final class Version20250608185310 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE user ADD site_id INT DEFAULT NULL, ADD is_super_admin TINYINT(1) DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE user ADD CONSTRAINT FK_8D93D649F6BD1646 FOREIGN KEY (site_id) REFERENCES site (id)
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_8D93D649F6BD1646 ON user (site_id)
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX IDX_8D93D649F6BD1646 ON user
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE user DROP site_id, DROP is_super_admin
        SQL);
    }
}
